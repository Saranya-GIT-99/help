    ...
    def export_to_excel(self, projects):
        ...
        with pd.ExcelWriter(filename, engine='openpyxl') as writer:
            ...
            for column in worksheet.columns:
                ...
                worksheet.column_dimensions[column_letter].width = min(max_length + 2, 50)  # Limit width
